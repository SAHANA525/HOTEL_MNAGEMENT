...
class Food implements Serializable
{
    ...
    Food(int itemno,int quantity)//constructor parameterized
    {
        this.itemno=itemno;
...
class Singleroom implements Serializable//interface convert to string
{
    String name;
    String contact;
    String gender;   
...
{
	//array list
    Doubleroom luxury_doublerrom[]=new Doubleroom[10]; //Luxury no. of rooms available 
...
class Hotel
{
    ...
    static void CustDetails(int i,int rn)//rn is size of room/no. of rooms
    {
        String name, contact, gender;
        String name2 = null, contact2 = null; //using one obj we cant access two car so null
        String gender2="";
        System.out.print("\nEnter customer name: ");//taking data from user using scanner class
        name = sc.next();
    ...
    static void availability(int i)
    {
    	...
    	System.out.println("Number of rooms available is:"+count);
...
class write implements Runnable//runnable interface
{
    holder hotel_ob;
